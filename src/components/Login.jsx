...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200">
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/50">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-red-100 rounded-2xl mb-3">
            <img src="/public/dmart.png" alt="D-Mart" className="w-10 h-10 object-contain" />
          </div>
        ...
        {recentIds.length > 0 && (
          <div className="mb-6 p-3 bg-gray-50 rounded-xl border border-gray-100">
            <div className="flex items-center justify-between mb-2">
              ...
              <button onClick={clearRecent} className="text-xs text-red-400 hover:text-red-600 transition font-medium">
                Clear
              </button>
            </div>
            <div className="flex flex-wrap gap-2">
              {recentIds.map(id => (
                <button
                  ...
                  className="px-3 py-1.5 bg-red-100 text-red-700 text-sm rounded-full hover:bg-red-200 transition font-medium"
                >
                  {id}
                </button>
              ))}
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/40 focus:border-red-500 text-sm transition-all bg-white/50"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500/40 focus:border-red-500 text-sm transition-all bg-white/50"
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-red-600 focus:ring-red-500/50" />
              <span className="text-sm text-gray-500 group-hover:text-gray-700 transition select-none">Remember me</span>
            </label>
            <Link to="/forgot-password" className="text-sm font-medium text-red-500 hover:text-red-700 transition hover:underline">
              Forgot password?
            </Link>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm flex items-center justify-center gap-2 shadow-lg shadow-red-500/25"
          >
            {loading ? (
              <>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          ...
          <Link to="/register" className="text-red-500 hover:text-red-700 font-medium hover:underline transition">
            Register
          </Link>
        </p>
