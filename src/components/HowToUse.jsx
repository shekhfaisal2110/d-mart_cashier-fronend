  ...
  const sections = [
    {
      ...
      steps: [
        ...
        'If you forget your password, use the <Link to="/forgot-password" className="text-red-600 hover:underline">Forgot password?</Link> link and follow the two‑step verification (Name + ID) to reset it.',
      ],
    },
    {
      title: '📊 Dashboard Overview',
      steps: [
        'The <Link to="/dashboard" className="text-red-600 hover:underline">Dashboard</Link> shows your monthly summary: total bill, total received, net variance, total discrepancy, and closing count.',
        '“Today’s Closing” shows the latest entry (if any).',
        '“Recent Closings” lists your last 5 entries – click <Link to="/all-reports" className="text-red-600 hover:underline">View all</Link> to see all reports.',
    ...
    },
    {
      ...
      steps: [
        'Go to <Link to="/closing" className="text-red-600 hover:underline">Closing Report</Link> from the sidebar.',
        'Select the date, optionally enter the bill amount (auto‑calculates if left blank).',
    ...
    },
    {
      ...
      steps: [
        'The <Link to="/closing" className="text-red-600 hover:underline">Closing Report</Link> page also includes filters: by date range, month (25th to 25th), or year.',
        'Use “CSV” and “PDF” buttons to download reports with totals.',
        'The <Link to="/all-reports" className="text-red-600 hover:underline">All Reports</Link> page shows all your entries with search, date, and status filters.',
        'You can see a summary of totals at the top.',
      ],
    },
    {
      ...
      steps: [
        ...
        'From there, you can <Link to="/change-password" className="text-red-600 hover:underline">change your password</Link> or log out.',
      ],
    },
    {
    ...
    <div className="p-4 sm:p-6 max-w-5xl mx-auto">
      ...
      <div className="space-y-6">
        {sections.map((section, idx) => (
          <div key={idx} className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
